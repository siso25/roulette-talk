...
RSpec.describe Roulette, type: :model do
  ...
  it 'returns third and fourth colors' do
    ...
    color_set = ['#6EB7DB', '#E38692', '#64C99B', '#E5D972', '#C97FB4']
    talk_themes = [talk_theme1, talk_theme2]
    css_text = Roulette.conic_gradient_text(talk_themes, color_set)
  ...
  it 'returns first through third colors' do
    ...
    color_set = ['#6EB7DB', '#E38692', '#64C99B', '#E5D972', '#C97FB4']
    talk_themes = [talk_theme1, talk_theme2, talk_theme3]
    css_text = Roulette.conic_gradient_text(talk_themes, color_set)
  ...
  it 'returns first through fourth colors' do
    ...
    color_set = ['#6EB7DB', '#E38692', '#64C99B', '#E5D972', '#C97FB4']
    talk_themes = [talk_theme1, talk_theme2, talk_theme3, talk_theme4]
    css_text = Roulette.conic_gradient_text(talk_themes, color_set)
  ...
  it 'returns first through fifth colors and third color' do
    ...
    talk_theme4 = roulette.talk_themes.build(theme: 'theme4')
    talk_theme5 = roulette.talk_themes.build(theme: 'theme5')
    talk_theme6 = roulette.talk_themes.build(theme: 'theme6')
    color_set = ['#6EB7DB', '#E38692', '#64C99B', '#E5D972', '#C97FB4']
    talk_themes = [talk_theme1, talk_theme2, talk_theme3, talk_theme4, talk_theme5, talk_theme6]
    css_text = Roulette.conic_gradient_text(talk_themes, color_set)
